<template>
  <div class="w-full min-h-screen bg-gray-100">
    <section class="text-center pt-7">
      <h1 class="text-5xl text-gray-800">What are we doing today?</h1>
    </section>
    <section 
    class="w-9/12 max-w-lg mx-auto flex items-center justify-center mt-7
    bg-white shadow p-5 rounded"
    >
      <form @submit.prevent>
